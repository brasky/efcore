...
",
                ...
                dbModel =>
                {
                    ...
                    var periodStart = columns.Single(c => c.Name == "SysStartTime");
                    var periodEnd = columns.Single(c => c.Name == "SysEndTime");
                    Assert.True((bool)periodStart[SqlServerAnnotationNames.Hidden]);
                    Assert.True((bool)periodEnd[SqlServerAnnotationNames.Hidden]);
...
",
                ...
                dbModel =>
                {
                    ...
                    var periodStart = columns.Single(c => c.Name == "SysStartTime");
                    var periodEnd = columns.Single(c => c.Name == "SysEndTime");
                    Assert.Null(periodStart[SqlServerAnnotationNames.Hidden]);
                    Assert.Null(periodEnd[SqlServerAnnotationNames.Hidden]);
                    Assert.Equal(3, table.Indexes.Count);
                },
                @"
ALTER TABLE dbo.HiddenColumnsTable SET (SYSTEM_VERSIONING = OFF);
